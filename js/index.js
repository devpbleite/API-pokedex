...
async function fetchPokemons() {
  ...
  const response = await fetch("https://pokeapi.co/api/v2/pokemon?limit=500$offset=1")
...
function insertPokemonHtml(pokemon) {
  ...
  <div class="pokemons-card" date-pokemon-card-type-name="eletric">
...
function initSearchFunciton(pokemons) {
